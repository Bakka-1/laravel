    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img src="https://laracast.com/_next/image?url=https%3A%2F%2Flaracast.com%2Fpublic%2Fimages%2Favatars%2Ftom.jpg&w=256&q=75" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
          </div>
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Lary robot</div>
            <div class="text-sm font-medium text-gray-400">bakka@example.com</div>
          </div>
